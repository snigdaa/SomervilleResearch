...
fig,ax,im,cbar = pg.plotting.image(s.stars,extent='50 kpc',Npx=200,qty='mass',
...
#save preliminarily in case the next part throws an error but so far it ran fine
